...
$A$をNoether環とする．任意の点列$\underline{a}=a_1,\dota,a_r$について$I=(a_1,\dots,a_r)$とおくと，任意の$A$加群$M$と$i\geq0$について$H^i_I(M)\cong\v{H}^i(\underline{a},M)$である（左辺は局所コホモロジー，右辺はČechコホモロジー）．
